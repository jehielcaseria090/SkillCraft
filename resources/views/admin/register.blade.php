...
<title>SkillCraft — Register Admin</title>
...
.sub{font-size:13px;color:rgba(255,255,255,0.55);margin-bottom:24px}
...
.link{text-align:center;margin-top:18px;font-size:13px;color:rgba(255,255,255,0.50)}
...
<div class="box">
  ...
  <p class="sub">Only admins can register here</p>
  ...
  <form method="POST" action="{{ route('admin.register.post') }}">
    ...
    <div class="grid-2">
      <div class="form-group">
        ...
        <input class="form-input" type="text" name="first_name" value="{{ old('first_name') }}" placeholder="Juan" required/>
      </div>
      <div class="form-group">
        <label class="form-label">Last Name</label>
        <input class="form-input" type="text" name="last_name" value="{{ old('last_name') }}" placeholder="Dela Cruz" required/>
      </div>
    </div>
    <div class="form-group">
      <label class="form-label">Email Address</label>
      <input class="form-input" type="email" name="email" value="{{ old('email') }}" placeholder="admin@skillcraft.com" required/>
    </div>
    <div class="form-group">
      <label class="form-label">Username</label>
      <input class="form-input" type="text" name="username" value="{{ old('username') }}" placeholder="admin123" required/>
    </div>
    <div class="grid-2">
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="input-wrap">
          ...
          <button type="button" class="toggle-pw" onclick="togglePw('password_confirmation','eye2')">
            <svg id="eye2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/>
            </svg>
          </button>
        </div>
  ...
  <div class="link">Already have an account? <a href="{{ route('admin.login') }}">Sign In</a></div>
</div>
<script>
